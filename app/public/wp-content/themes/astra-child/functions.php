        ...
        <div class="topbar-inner">
            ...
            <div class="topbar-item">
                ...
                <span class="topbar-text">
                    Hotline: <a href="tel:0703553999">070 3553 999</a> | <a href="tel:0942375558">094 2375 558</a>
                </span>
            </div>
        ...
        while ($query->have_posts()):
            ...
            <div class="product-card">
                ...
                <?php if ($product->is_in_stock()): ?>
                    ...
                    <a href="tel:0703553999" class="btn-add-to-cart mt-2 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="call-icon me-2" width="16" height="16" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path
                                d="M22 16.92v3a2 2 0 0 1-2.18 2 19.86 19.86 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.86 19.86 0 0 1-3.07-8.63A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.94.37 1.87.72 2.75a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.33-1.33a2 2 0 0 1 2.11-.45c.88.35 1.81.59 2.75.72A2 2 0 0 1 22 16.92z" />
                        </svg>
